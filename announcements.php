...
<section class="py-5" style="min-height: 80vh;">
	<div class="container">
		...
		<div class="text-center mb-5">
			...
			<p class="text-dark opacity-75 lead">Stay updated with the latest news and announcements from your barangay.</p>
		</div>
		...
		<?php if (empty($announcements)): ?>
			...
			<div class="text-center py-5">
				...
				<p class="text-dark opacity-50">There are currently no announcements. Check back later!</p>
			</div>
		<?php else: ?>
			<div class="row g-4">
