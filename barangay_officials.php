...
<style>
    body { background: #ffffff; min-height: 100vh; color: #475569; font-family: 'Manrope', sans-serif; }
    
    .official-item { margin-bottom: 2rem; transition: transform 0.3s ease; cursor: pointer; text-align: center; }
...
<div class="container py-5 mt-4">
    ...
    <?php if ($captain): ?>
    <div class="official-item mb-5">
        <div class="photo-wrapper captain-photo">
            <?php $c_img = $captain['image_path'] ?: 'public/img/barangaylogo.png'; ?>
            <img src="<?php echo $c_img; ?>" class="w-100 h-100 object-fit-cover" alt="Captain">
        </div>
        ...
        <?php foreach ($councilors as $c): ?>
            <div class="official-item council-item text-center">
                <div class="photo-wrapper member-photo">
                    ...
                    <img src="<?php echo $o_img; ?>" class="w-100 h-100 object-fit-cover" alt="Official">
                </div>
