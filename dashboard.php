...
<div class="container py-5 animate__animated animate__fadeInUp">
    ...
    <div class="row g-4 mb-5">
        <div class="col-lg-5">
            <div class="card border-0 shadow-sm rounded-4 h-100">
                <div class="card-header bg-transparent border-0 pt-4 pb-0 px-4">
                    <h5 class="fw-bold mb-0 text-dark"><i class="fas fa-chart-pie me-2 text-primary"></i>Documents Request</h5>
                </div>
        ...
        <div class="col-lg-7">
            <div class="row g-4">
                <!-- Pending Card -->
                <div class="col-md-6">
                    <a href="requests.php" class="text-decoration-none" style="color: inherit; display: block; border-radius: 12px; overflow: hidden; transition: transform 0.2s;">
                        <div class="admin-stats-card warning mb-0" style="margin: 0; border: none; box-shadow: 0 4px 6px -1px rgba(0,0,0,.1), 0 2px 4px -1px rgba(0,0,0,.06);">
                            <div class="d-flex align-items-center p-4" style="color: white;">
                                <div class="stats-icon me-3" style="font-size: 2rem; opacity: 0.9;"><i class="fas fa-clock"></i></div>
                                <div>
                                    <div class="stats-number" style="font-size: 2rem; font-weight: bold; line-height: 1; margin-bottom: 0.25rem;"><?php echo $total_pending; ?></div>
                ...
                <div class="col-md-6">
                    <a href="requests.php" class="text-decoration-none" style="color: inherit; display: block; border-radius: 12px; overflow: hidden; transition: transform 0.2s;">
                        <div class="admin-stats-card success mb-0" style="margin: 0; border: none; box-shadow: 0 4px 6px -1px rgba(0,0,0,.1), 0 2px 4px -1px rgba(0,0,0,.06);">
                            <div class="d-flex align-items-center p-4" style="color: white;">
                                <div class="stats-icon me-3" style="font-size: 2rem; opacity: 0.9;"><i class="fas fa-check-circle"></i></div>
                                <div>
                                    <div class="stats-number" style="font-size: 2rem; font-weight: bold; line-height: 1; margin-bottom: 0.25rem;"><?php echo $total_approved; ?></div>
                                    <div class="stats-label" style="font-size: 0.9rem; opacity: 0.9;">Ready to Pickup</div>
                                </div>
                            </div>
                        </div>
                    </a>
                ...
                <div class="col-md-6">
                    <a href="requests.php" class="text-decoration-none" style="color: inherit; display: block; border-radius: 12px; overflow: hidden; transition: transform 0.2s;">
                        <div class="admin-stats-card info mb-0" style="margin: 0; border: none; box-shadow: 0 4px 6px -1px rgba(0,0,0,.1), 0 2px 4px -1px rgba(0,0,0,.06);">
                            <div class="d-flex align-items-center p-4" style="color: white;">
                                <div class="stats-icon me-3" style="font-size: 2rem; opacity: 0.9;"><i class="fas fa-hand-holding"></i></div>
                                <div>
                                    <div class="stats-number" style="font-size: 2rem; font-weight: bold; line-height: 1; margin-bottom: 0.25rem;"><?php echo $total_released; ?></div>
                ...
                <div class="col-md-6">
                    <a href="requests.php" class="text-decoration-none" style="color: inherit; display: block; border-radius: 12px; overflow: hidden; transition: transform 0.2s;">
                        <div class="admin-stats-card danger mb-0" style="margin: 0; border: none; box-shadow: 0 4px 6px -1px rgba(0,0,0,.1), 0 2px 4px -1px rgba(0,0,0,.06);">
                            <div class="d-flex align-items-center p-4" style="color: white;">
                                <div class="stats-icon me-3" style="font-size: 2rem; opacity: 0.9;"><i class="fas fa-times-circle"></i></div>
                                <div>
                                    <div class="stats-number" style="font-size: 2rem; font-weight: bold; line-height: 1; margin-bottom: 0.25rem;"><?php echo $total_rejected; ?></div>
    ...
    <div class="row g-4 mb-5">
        <div class="col-lg-5 order-lg-2">
            <div class="card border-0 shadow-sm rounded-4 h-100">
                <div class="card-header bg-transparent border-0 pt-4 pb-0 px-4">
                    <h5 class="fw-bold mb-0 text-dark"><i class="fas fa-exclamation-triangle me-2 text-danger"></i>Incidents Report</h5>
                </div>
                <div class="card-body d-flex flex-column justify-content-center align-items-center p-4">
        ...
        <div class="col-lg-7 order-lg-1">
            <div class="row g-4">
                <!-- Submitted Card -->
                <div class="col-md-12">
                    <a href="incidents.php" class="text-decoration-none" style="color: inherit; display: block; border-radius: 12px; overflow: hidden; transition: transform 0.2s;">
                        <div class="admin-stats-card danger mb-0" style="margin: 0; border: none; box-shadow: 0 4px 6px -1px rgba(0,0,0,.1), 0 2px 4px -1px rgba(0,0,0,.06);">
                            <div class="d-flex align-items-center p-4" style="color: white;">
                                <div class="stats-icon me-4" style="font-size: 2.5rem; opacity: 0.9;"><i class="fas fa-file-signature"></i></div>
                                <div>
                                    <div class="stats-number" style="font-size: 2.25rem; font-weight: bold; line-height: 1; margin-bottom: 0.25rem;"><?php echo $incidents_submitted; ?></div>
                                    <div class="stats-label" style="font-size: 1rem; opacity: 0.9;">Submitted Incidents</div>
                                </div>
                            </div>
                        </div>
                    </a>
                ...
                <div class="col-md-6">
                    <a href="incidents.php" class="text-decoration-none" style="color: inherit; display: block; border-radius: 12px; overflow: hidden; transition: transform 0.2s;">
                        <div class="admin-stats-card info mb-0" style="margin: 0; border: none; box-shadow: 0 4px 6px -1px rgba(0,0,0,.1), 0 2px 4px -1px rgba(0,0,0,.06);">
                            <div class="d-flex align-items-center p-4" style="color: white;">
                                <div class="stats-icon me-3" style="font-size: 2rem; opacity: 0.9;"><i class="fas fa-search"></i></div>
                                <div>
                                    <div class="stats-number" style="font-size: 2rem; font-weight: bold; line-height: 1; margin-bottom: 0.25rem;"><?php echo $incidents_review; ?></div>
                ...
                <div class="col-md-6">
                    <a href="incidents.php" class="text-decoration-none" style="color: inherit; display: block; border-radius: 12px; overflow: hidden; transition: transform 0.2s;">
                        <div class="admin-stats-card success mb-0" style="margin: 0; border: none; box-shadow: 0 4px 6px -1px rgba(0,0,0,.1), 0 2px 4px -1px rgba(0,0,0,.06);">
                            <div class="d-flex align-items-center p-4" style="color: white;">
                                <div class="stats-icon me-3" style="font-size: 2rem; opacity: 0.9;"><i class="fas fa-check-double"></i></div>
                                <div>
                                    <div class="stats-number" style="font-size: 2rem; font-weight: bold; line-height: 1; margin-bottom: 0.25rem;"><?php echo $incidents_resolved; ?></div>
    ...
    <div class="row g-4 mb-5">
            ...
            <a href="requests.php" class="text-decoration-none">
                <div class="card border-0 shadow-sm rounded-4 h-100 btn-hover-effect bg-white">
                    <div class="card-body p-4 text-center">
                        <div class="rounded-circle bg-primary bg-opacity-10 text-primary d-inline-flex align-items-center justify-content-center mb-3" style="width: 65px; height: 65px;">
        ...
        <div class="col-md-4">
            <a href="incidents.php" class="text-decoration-none">
                <div class="card border-0 shadow-sm rounded-4 h-100 btn-hover-effect bg-white">
                    <div class="card-body p-4 text-center">
                        <div class="rounded-circle bg-danger bg-opacity-10 text-danger d-inline-flex align-items-center justify-content-center mb-3" style="width: 65px; height: 65px;">
        ...
        <div class="col-md-4">
            <a href="profile.php" class="text-decoration-none">
                <div class="card border-0 shadow-sm rounded-4 h-100 btn-hover-effect bg-white">
                    <div class="card-body p-4 text-center">
                        <div class="rounded-circle bg-info bg-opacity-10 text-info d-inline-flex align-items-center justify-content-center mb-3" style="width: 65px; height: 65px;">
