...
foreach ($lines as $i => $line) {
    ...
    elseif (strpos($line, '<div class="col-md-4">') !== false && isset($lines[$i+1]) && strpos($lines[$i+1], '<div class="section-label"><i class="fas fa-calendar"></i> Birthdate</div>') !== false) {
    ...
    elseif (strpos($line, '<div class="col-md-4">') !== false && isset($lines[$i+1]) && strpos($lines[$i+1], '<div class="section-label"><i class="fas fa-venus-mars"></i> Sex</div>') !== false) {
        $output[] = '                                <div class="col-md-6">' . "\n";
    }
    elseif (strpos($line, '<div class="col-md-4">') !== false && isset($lines[$i+1]) && strpos($lines[$i+1], '<div class="section-label"><i class="fas fa-heart"></i> Civil Status</div>') !== false) {
        $output[] = '                                <div class="col-md-6">' . "\n";
    }
    else {
        $output[] = $line;
