            ...
            <div class="card-body p-4">
                ...
                <div class="d-flex flex-wrap align-items-center justify-content-between gap-3 mb-4">
                    <div class="d-flex align-items-center gap-3">
                        <div
                            class="width-12 height-12 rounded-3 bg-blue-50 text-blue-600 d-flex align-items-center justify-content-center">
                ...
                <?php if ($info): ?>
                    <div
                        class="alert alert-success alert-dismissible fade show border-0 bg-teal-50 text-teal-600 rounded-3 mb-4">
                ...
                <?php if ($error): ?>
                    <div
                        class="alert alert-danger alert-dismissible fade show border-0 bg-rose-50 text-rose-600 rounded-3 mb-4">
                            ...
                            <?php if (empty($rows)): ?>
                                <tr>
                                    <td colspan="5" class="text-center py-5 text-secondary">
                                        ...
                                        <button class="btn btn-sm btn-link mt-2" data-bs-toggle="modal"
                                            data-bs-target="#newIncidentModal">Report your first incident</button>
                                    </td>
                                </tr>
                            <?php else: ?>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="fw-bold text-dark ps-2">
                                                <?php echo htmlspecialchars($_SESSION['full_name'] ?? 'Resident'); ?></div>
                                        </td>
                                        <td class="text-dark fw-medium">
                                            <?php echo date('M j, Y', strtotime($r['created_at'])); ?>
                                            <div class="small opacity-50">
                                                <?php echo date('g:i A', strtotime($r['created_at'])); ?></div>
                                        </td>
                                            ...
                                            <div class="d-flex justify-content-center gap-2">
                                                ...
                                                <?php if ($r['status'] === 'submitted'): ?>
                                                    <form method="post" class="d-inline cancel-inc-form">
                                                        <?php echo csrf_field(); ?>
                                                        <input type="hidden" name="cancel_incident_id"
                            ...
                            <div class="modal-header border-bottom p-4 bg-light">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-dark opacity-75 small mb-0">Detailed information about the
                                            reported incident</p>
                                    </div>
                                </div>
                                ...
                                <div id="viewContent" class="d-none animate__animated animate__fadeIn">
                                    <div class="row g-0">
                                        ...
                                        <div class="col-lg-8 p-4 bg-white">
                                            ...
                                            <div class="mb-4">
                                                <h6
                                                    class="text-dark small fw-bold text-uppercase border-bottom pb-2 mb-3">
                                                    Incident Information</h6>
                                                <div class="row g-3">
                                                    <div class="col-md-6 text-dark small fw-semibold d-flex">
                                                        <span class="text-dark opacity-75 me-2">Status:</span>
                                                        <span id="viewStatus"
                                                            class="badge rounded-pill px-3 py-1 fw-bold"></span>
                                                    </div>
                                                    <div class="col-md-6 text-dark small fw-semibold d-flex">
                                                    ...
                                                    <div class="col-12">
                                                        <label
                                                            class="text-dark small fw-bold d-block mb-1">Description:</label>
                                                        <div class="bg-light p-3 rounded-3 border-0">
                                                            <p id="viewDescription" class="text-dark mb-0"
                                                                style="white-space: pre-wrap; line-height: 1.6;"></p>
                                                        </div>
                                                    </div>
                                                    <div id="viewImageContainer" class="col-12 d-none">
                                                        <div class="rounded-4 overflow-hidden border shadow-sm mt-2"
                                                            style="max-height: 300px;">
                                                            <img id="viewImage" src=""
                                                                class="w-100 h-100 object-fit-contain bg-dark cursor-pointer"
                                            ...
                                            <div class="mb-4">
                                                ...
                                                <div class="row g-3">
                                                    ...
                                                    <div class="col-md-6 small fw-semibold">
                                                        ...
                                                        <a href="" id="viewResPhoneLink"
                                                            class="text-primary text-decoration-none d-flex align-items-center">
                                                            <i class="fas fa-phone-alt me-1 x-small"></i><span
                                                                id="viewResPhone"></span>
                                                        </a>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div>
                                                ...
                                                <div class="row g-3">
                                                    ...
                                                    <div class="col-12">
                                                        <div id="viewMap" style="height: 250px;"
                                                            class="rounded-4 border shadow-sm mb-3"></div>
                                                        <div class="d-flex gap-2">
                                                            <a id="linkGMap" href="#" target="_blank"
                                                                class="btn btn-sm btn-teal flex-fill py-2 text-white fw-bold">
                                                                <i class="fab fa-google me-1"></i> Google Maps
                                                            </a>
                                                            <a id="linkWaze" href="#" target="_blank"
                                                                class="btn btn-sm btn-rose flex-fill py-2 text-white fw-bold">
                                        ...
                                        <div class="col-lg-4 border-start bg-light bg-opacity-50">
                                            ...
                                            <div class="p-4 border-bottom bg-white bg-opacity-75">
                                                ...
                                                <div class="d-grid gap-2">
                                                    <a href="incidents.php"
                                                        class="btn btn-white border shadow-sm btn-sm py-2 text-secondary fw-semibold">
                                            ...
                                            <div class="p-4">
                                                ...
                                                <div id="viewTimeline" class="timeline-container pe-2"
                                                    style="max-height: 400px; overflow-y: auto;">
                                                    <!-- Messages loaded here -->
                                                </div>
                                                <div class="mt-4 pt-3 border-top d-grid">
                                                    <a id="goToDetails" href="#"
                                                        class="btn btn-primary rounded-pill py-2 shadow-sm fw-bold btn-sm">
                                                        Open Full View & Reply <i
                ...
                <div class="toast-container position-fixed bottom-0 end-0 p-3">
                    <div id="systemToast" class="toast border-0 shadow-lg rounded-3" role="alert" aria-live="assertive"
                        aria-atomic="true">
                ...
                <form method="post" enctype="multipart/form-data" id="incidentForm">
                    ...
                    <?php if (!$is_account_active): ?>
                        <div class="alert alert-danger border-0 bg-rose-50 text-rose-600 rounded-3 mb-4">
                            ...
                            <strong>Account Inactive:</strong> Your account is currently deactivated. You cannot report new
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-md-7">
                            <label class="form-label fw-semibold text-dark opacity-50 small text-uppercase">1. Pin
                                Location</label>
                            <div class="bg-light p-3 rounded-3 mb-3">
                                <div class="input-group mb-3 shadow-none border rounded-3 overflow-hidden">
                                    ...
                                    <input type="text" id="locationSearch"
                                        class="form-control border-0 shadow-none px-0" style="font-size: 0.9rem;"
                                        placeholder="Search street or landmark...">
                                    <button class="btn btn-primary px-3 fw-semibold btn-sm" type="button"
                                        id="searchLocationBtn">Search</button>
                                </div>
                                <div class="d-flex gap-2 mb-2">
                                    <button type="button"
                                        class="btn btn-white btn-sm border shadow-sm flex-fill py-2 text-secondary fw-semibold location-btn"
                        ...
                        <div class="col-md-5">
                            <div class="mb-4">
                                <label class="form-label fw-semibold text-dark opacity-50 small text-uppercase">2.
                                    Describe Incident</label>
                                <textarea name="description" class="form-control bg-light border-0" rows="5"
                                    style="font-size: 0.9rem;" placeholder="What happened?" required></textarea>
                            </div>

                            <div class="mb-4">
                                <label class="form-label fw-semibold text-dark opacity-50 small text-uppercase">3.
                                    Upload Proof (Optional)</label>
                                <input type="file" name="incident_image" id="incident_image"
                                    class="form-control form-control-sm bg-light border-0" accept="image/*">
                                <div id="imagePreview" class="mt-2 d-none">
                                    <img id="previewImg" src="" alt="Preview" class="img-fluid rounded-2 shadow-sm"
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content border-0 shadow-lg rounded-4">
            <div class="modal-body text-center p-5">
                <div class="mb-4">
                    <div class="rounded-circle bg-rose-50 d-inline-flex align-items-center justify-content-center mx-auto"
                ...
                <div class="mb-4 text-start">
                    <textarea id="incidentCancelReasonInput" class="form-control bg-light border-0" rows="3"
                        placeholder="State your reason for cancellation..." required></textarea>
                    <div id="incidentCancelReasonError" class="text-danger small mt-1" style="display: none;">Please
                        provide a reason.</div>
                </div>
                <div class="d-flex gap-3 justify-content-center">
                    <button type="button" class="btn btn-light rounded-pill px-4" data-bs-dismiss="modal">No,
                        Keep</button>
                    <button type="button" class="btn btn-danger rounded-pill px-4" id="confirmIncidentCancelBtn">Yes,
                        Cancel</button>
                </div>
            </div>
        </div>
