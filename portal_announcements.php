...
if (is_admin()) redirect('admin/announcements.php');
    ...
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content border-0 shadow-lg rounded-4 overflow-hidden">
            <div id="modalMediaContainer" class="d-none bg-dark bg-opacity-10 d-flex align-items-center justify-content-center" style="min-height: 300px;">
                <img id="modalMedia" src="" alt="" class="img-fluid" style="max-height: 500px; width: auto; object-fit: contain; image-rendering: -webkit-optimize-contrast;">
            </div>
